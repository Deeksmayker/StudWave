        ...
        public static Dictionary<string, List<ChoiceBranch>> FillBranches()
        {
            ...
            var HOMElist = new List<ChoiceBranch>
            {
                ...
                new ChoiceBranch()
                {
                    ...
                    {
                        Answer = "Лечь спать",
                        SuccesAfterAnswer = "Спокойной ночи.",
                        CheckSucces = () => true,
                        PlayerInteract = (checkSucces) =>
                        {
                            if (checkSucces)
                    ...
                    SecondChoice = new Choice
                    {
                        Answer = "Приготовить еду",
                        SuccesAfterAnswer = "У тебя получилось приготовить еду",
                        FailAfterAnswer = "У тебя не получилось приготовить еду",
                        CheckSucces = () => true,
                        PlayerInteract = (checkSucces) =>
                        {
                            if (checkSucces)
                    ...
                    ThirdChoice = new Choice
                    {
                        Answer = "Заняться учебой",
                        SuccesAfterAnswer = "Ты немного подтянул учебу",
                        CheckSucces = () => true,
                        PlayerInteract = (checkSucces) =>
                        {
                            if (checkSucces)
            ...
            var CAFElist = new List<ChoiceBranch>
            {
                new ChoiceBranch()
                {
                    Message = "Ты пришел в кафе и открыл меню, что выберешь?",
                    FirstChoice = new Choice
                    {
                        Answer = "Заказать большую порцию пюре с котлетой",
                        SuccesAfterAnswer = "Ты поел и утолил голод",
                        FailAfterAnswer = "У тебя не хватает денег",
                        CheckSucces = () => player.Money >= 500,
                        PlayerInteract = (checkSucces) =>
                        {
                            if (checkSucces)
                            {
                    ...
                    SecondChoice = new Choice
                    {
                        Answer = "Бургер с колой и быстро перекусить",
                        SuccesAfterAnswer = "Ты поел и немного утолил голод",
                        FailAfterAnswer = "У тебя не хватает денег",
                        CheckSucces = () => player.Money >= 300,
                        PlayerInteract = (checkSucces) =>
                        {
                            if (checkSucces)
                            {
                    ...
                    ThirdChoice = new Choice
                    {
                        Answer = "Выпить чай с выпечкой",
                        SuccesAfterAnswer = "Ты перекусил и немного утолил голод",
                        FailAfterAnswer = "У тебя не хватает денег",
                        CheckSucces = () => player.Money >= 100,
                        PlayerInteract = (checkSucces) =>
                        {
                            if (checkSucces)
                            {
